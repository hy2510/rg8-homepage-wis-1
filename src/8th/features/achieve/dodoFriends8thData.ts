...
export function getDodoFriends8thData(langCode?: string) {
  switch (langCode) {
    case KOREAN:
      return dodofriends8th
    default:
      return dodofriendsEn8th
  }
}

const dodofriends8th: DodoFriends8thType[] = [
  {
    id: 'Baro',
    name: '바로',
    minPoint: 0,
...
const dodofriendsEn8th: DodoFriends8thType[] = [
  {
    id: 'Baro',
    name: '바로',
    minPoint: 0,
