...
import { useFetchReadkingkingGroupRanking } from '@/client/store/ranking/readingking-group/hook'
import { RankReadingkingGroup } from '@/repository/client/object/rank-readingking-group'
