...
import { HomeExtraData, HomeLayout } from '@/repository/client/object/main'
    ...
    <div
      ...
      <div
        ...
        <div className={style.home_banner_buttons}>
          ...
          <Link href={workbooklink} target="_blank">
            <div className={style.option_button}>
              <Image
      ...
      <div className={style.home_partnership} style={{ height: '100%' }}>
        <div className={style.row}>
          ...
          <div className={style.partner_banner_group}>
            <Link href={'https://www.woodo.kr/readinggate'} target="_blank">
          ...
          <div className={style.partner_banner_group}>
            <Link href={'https://www.millie.co.kr/'} target="_blank">
          ...
          <div className={style.partner_banner_group}>
            <Link href={'https://www.caihong.co.kr/info/child'} target="_blank">
